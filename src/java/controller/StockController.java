    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            if(service.equals("insertStock")){
                ...
                String sqlStore="Select * from Stores";
                ResultSet rsPro=dao.getData(sqlPro),
                        rsStore=dao.getData(sqlStore);
                request.setAttribute("pro",rsPro);
                request.setAttribute("store",rsStore);
                
                disp(request, response,"/insertStock.jsp");
